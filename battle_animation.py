...
class BattleAnimation:
    ...
    def start(self, game_state, defending_action, attacking_player,
              defending_player):
        """开始战斗动画"""
        ...
        defend_row, defend_col = defending_action // board_size, defending_action % board_size
        ...
        for row in range(board_size):
            for col in range(board_size):
                ...
                if ascend_state[row][col]:
                    # 将棋盘坐标转换为像素坐标
                    pixel_x = self.board.LeftUP_Point[
                        0] + col * self.board.Distance
                    pixel_y = self.board.LeftUP_Point[
                        1] + row * self.board.Distance
    ...
    def _handle_collision(self, piece1, piece2):
        ...
        if piece1['has_plant'] != piece2['has_plant']:
            ...
            # 新棋子的玩家属性由攻击方决定
            new_player = piece1['player'] if piece1['has_plant'] else piece2[
                'player']
